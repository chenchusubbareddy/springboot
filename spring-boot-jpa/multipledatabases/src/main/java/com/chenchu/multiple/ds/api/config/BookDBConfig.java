package com.chenchu.multiple.ds.api.config;
...
@EnableJpaRepositories(entityManagerFactoryRef = "bookEntityManagerFactory", transactionManagerRef = "bookTransactionManager", basePackages = {
		"com.chenchu.multiple.ds.api.book.repository" })
public class BookDBConfig {
	...
	public LocalContainerEntityManagerFactoryBean bookEntityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(dataSource).properties(properties)
				.packages("com.chenchu.multiple.ds.api.model.book").persistenceUnit("Book").build();
	}
